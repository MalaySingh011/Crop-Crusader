...
public class Player2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            Run();
            // Attacking
            if (Input.GetKey(KeyCode.DownArrow) && staminaHealth.currentStamina - 5 >= 0)
            {
                isAttacking = true;
                Attack();
            }
            ...
            // Running
            if (Input.GetKey(KeyCode.RightShift) && staminaHealth.currentStamina - 5 > 0)
            {
    ...
    private void Run()
    {
        ...
        if (Input.GetKey(KeyCode.RightShift) && staminaHealth.currentStamina > 0)
        {
